...
if (isset($_POST['submit'])){
 ...
 <html lang="en" dir="ltr">
   ...
   <body style="background-color:#fff7b3">
     ...
     <?php
      ...
      <div class="container">
        ...
        <form method="post" name="tcredit" class="tabletext"><br>
            ...
            <div class="text-center">
                <button class="btn btn-lg btn-success mt-3" name="submit" type="submit" id="myBtn">Transfer</button>
            </div>
        </form>
    </div>
      ...
      <div class="container-fluid" style="background-color:#fffacc">
